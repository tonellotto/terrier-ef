...
*/
			...
			EFBlockLexiconEntry leOut = new EFBlockLexiconEntry(le.getTermId(), le.getDocumentFrequency(), le.getFrequency(), le.getMaxFrequencyInDocuments(), docidsOffset, freqsOffset, posOffset, sumMaxPos);
