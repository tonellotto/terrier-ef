...
public class VarintInvertedIndex implements PostingIndex<BitIndexPointer>
{
	...
	public VarintInvertedIndex(IndexOnDisk index, String structureName) throws IOException 
	{
		this(index, structureName, index.getDocumentIndex());
	}

	@SuppressWarnings("resource")
	public VarintInvertedIndex(IndexOnDisk index, String structureName, DocumentIndex _doi) throws IOException
	{
		this.index = index;
		this.doi = _doi;
	...
	{
		VarintLexiconEntry le = (VarintLexiconEntry)pointer;
