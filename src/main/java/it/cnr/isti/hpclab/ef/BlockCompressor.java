...
public class BlockCompressor extends Compressor
{
    ...
    public BlockCompressor(final Index src_index, final IndexRef dst_ref)
    {
        this(src_index, dst_ref, Integer.parseInt(System.getProperty(EliasFano.LOG2QUANTUM, "8")));
    }
    
    public BlockCompressor(final Index src_index, final IndexRef dst_ref, final int log2quantum)
    {
